...
type User struct {
	...
	Name        *User_Name `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`
	PhoneNumber int32      `protobuf:"varint,4,opt,name=phone_number,json=phoneNumber,proto3" json:"phone_number,omitempty"`
}
...
func (x *CreateNewUserRequest) GetUser() *User {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *User_Name) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*User_Name) ProtoMessage() {}

func (x *User_Name) ProtoReflect() protoreflect.Message {
	mi := &file_proto_user_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use User_Name.ProtoReflect.Descriptor instead.
func (*User_Name) Descriptor() ([]byte, []int) {
	return file_proto_user_proto_rawDescGZIP(), []int{0, 0}
}

func (x *User_Name) GetFirstName() string {
	if x != nil {
		return x.FirstName
	}
	return ""
...
func (x *User_Name) GetLastName() string {
	if x != nil {
		return x.LastName
	}
	return ""
...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x07, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x1a, 0x1b, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x65, 0x6d, 0x70,
	0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbb, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65,
	...
	0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x26, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e,
	0x55, 0x73, 0x65, 0x72, 0x2e, 0x4e, 0x61, 0x6d, 0x65, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12,
	0x21, 0x0a, 0x0c, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x4e, 0x75, 0x6d, 0x62,
	0x65, 0x72, 0x1a, 0x42, 0x0a, 0x04, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x66, 0x69,
	...
	0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x39, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x4e, 0x65, 0x77, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x21,
	...
	0x72, 0x22, 0x3a, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x55, 0x73, 0x65, 0x72, 0x73,
	...
	0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x20, 0x0a,
	...
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x32, 0xc3, 0x02, 0x0a,
	0x05, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x3f, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x4e, 0x65, 0x77, 0x55, 0x73, 0x65, 0x72, 0x12, 0x1d, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76,
	...
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x22, 0x00, 0x12, 0x45, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x41, 0x6c,
	...
	0x72, 0x22, 0x00, 0x12, 0x39, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65,
	...
	0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x22, 0x00, 0x12, 0x42,
	...
	0x2f, 0x6a, 0x69, 0x74, 0x74, 0x61, 0x73, 0x68, 0x2f, 0x67, 0x6f, 0x2d, 0x67, 0x72, 0x70, 0x63,
...
var file_proto_user_proto_goTypes = []interface{}{
	...
	(*CreateNewUserRequest)(nil), // 1: user.v1.CreateNewUserRequest
	(*GetAllUsersResponse)(nil),  // 2: user.v1.GetAllUsersResponse
	...
	(*User_Name)(nil),            // 6: user.v1.User.Name
	(*emptypb.Empty)(nil),        // 7: google.protobuf.Empty
}
var file_proto_user_proto_depIdxs = []int32{
	6, // 0: user.v1.User.name:type_name -> user.v1.User.Name
	0, // 1: user.v1.CreateNewUserRequest.user:type_name -> user.v1.User
	0, // 2: user.v1.GetAllUsersResponse.users:type_name -> user.v1.User
	0, // 3: user.v1.UpdateUserRequest.user:type_name -> user.v1.User
	1, // 4: user.v1.Users.CreateNewUser:input_type -> user.v1.CreateNewUserRequest
	7, // 5: user.v1.Users.GetAllUsers:input_type -> google.protobuf.Empty
	3, // 6: user.v1.Users.GetUser:input_type -> user.v1.GetUserRequest
	4, // 7: user.v1.Users.UpdateUser:input_type -> user.v1.UpdateUserRequest
	5, // 8: user.v1.Users.DeleteUser:input_type -> user.v1.DeleteUserRequest
	0, // 9: user.v1.Users.CreateNewUser:output_type -> user.v1.User
	2, // 10: user.v1.Users.GetAllUsers:output_type -> user.v1.GetAllUsersResponse
	0, // 11: user.v1.Users.GetUser:output_type -> user.v1.User
	0, // 12: user.v1.Users.UpdateUser:output_type -> user.v1.User
	7, // 13: user.v1.Users.DeleteUser:output_type -> google.protobuf.Empty
